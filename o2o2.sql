/*
 ...
 Source Server         : aliwaiwangdatabase
 Source Server Type    : MySQL
 Source Server Version : 80018
 Source Host           : xinsheng.mysql.rds.aliyuncs.com:3306
 Source Schema         : o2o
...
-- Records of tb_area
-- ----------------------------
INSERT INTO `tb_area` VALUES (1, '西苑', 1, '2022-10-25 14:21:22', NULL);
INSERT INTO `tb_area` VALUES (2, '东苑', 2, '2022-10-25 14:21:43', NULL);
...
-- ----------------------------
INSERT INTO `tb_person_info` VALUES (1, '测试 ', '1', 2, 'test@qq.com', 'test', NULL, NULL, 1);
...
CREATE TABLE `tb_shop`  (
  ...
  INDEX `fk_shop_parentcate`(`parent_category_id`) USING BTREE,
...
-- Records of tb_shop
-- ----------------------------
INSERT INTO `tb_shop` VALUES (1, 1, 1, 33, 33, '咖啡店', '东元的额', NULL, NULL, NULL, 0, NULL, NULL, 0, NULL);
...
-- ----------------------------
INSERT INTO `tb_shop_category` VALUES (33, '咖啡奶茶', '咖啡奶茶', 'test', 1, NULL, NULL, 33);
